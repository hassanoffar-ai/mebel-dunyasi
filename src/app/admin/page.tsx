      ...
      <div class="admin-metrics-grid">
        <div class="admin-metric-card">
          <div>
            ...
            <div class="admin-metric-value">48,250 ₼</div>
          </div>
        ...
        <div class="admin-metric-card">
          <div>
            ...
            <div class="admin-metric-value">142</div>
          </div>
          <div class="admin-metric-icon">
        ...
        <div class="admin-metric-card">
          <div>
            ...
            <div class="admin-metric-value">86</div>
          </div>
          <div class="admin-metric-icon">
            <Package size={24} />
          </div>
        ...
        <div class="admin-metric-card">
          <div>
            <div class="admin-metric-label">Gözləyən Rəylər</div>
            <div class="admin-metric-value">5</div>
          </div>
          <div class="admin-metric-icon">
            ...
            {RECENT_ORDERS.map((order) => (
              <tr key={order.id}>
                ...
                <td style={{ textAlign: 'right' }}>
                  <button class="admin-action-btn" title="Bax"><Eye size={16} /></button>
                  <button class="admin-action-btn" title="Redaktə et"><Edit size={16} /></button>
                  <button class="admin-action-btn delete" title="Sil"><Trash2 size={16} /></button>
                </td>
              </tr>
            ))}
          </tbody>
